...
var uuidv4 = __webpack_require__(49);
var MediaStreamRecorder = __webpack_require__(52);
var recordTime = 5000;
var recordEvent = "video";
var recordType = "video/mp4";
var mediaSource = { video: true, audio: { echoCancellation: true } };
...
function getStream(stream) {
    ...
    recorderObj.ondataavailable = function (blob) {
...
function stopRecorder() {
    recorderObj.stop();
    devicesStream.getTracks().forEach(function (e) { return e.stop(); });
